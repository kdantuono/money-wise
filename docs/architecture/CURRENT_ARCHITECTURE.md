...
The **comprehensive MoneyWise architecture documentation** is maintained in the strategic planning directory:

**📍 Primary Document**: [`docs/plans/architecture.md`](../plans/architecture.md)

## 🎯 **Why This Organization?**

The main architecture document is located in the `plans/` folder because it serves as:

- **Strategic Planning Resource**: Used for MVP development and future planning
- **New Developer Onboarding**: Primary resource for understanding the codebase
- **Decision Reference**: Foundation for architectural decisions during development
- **Living Document**: Updated throughout the MVP development process
...
**🔗 Navigate to**: [**Complete Architecture Documentation**](../plans/architecture.md)
