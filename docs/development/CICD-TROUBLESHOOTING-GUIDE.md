...
```sql
-- ⚠️ WARNING: This drops a column that may have been added in a previous migration
...
- name: Install Playwright system deps (cache hit)
  ...
  run: |
    cd apps/web
    npx playwright install-deps  # ❌ WRONG: Only installs system deps, NOT browser binaries!
```
