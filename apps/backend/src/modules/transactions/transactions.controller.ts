...
export class TransactionsController {
  ...
  async getByCategory(@Request() req, @Query('period') period?: string) {
    return await this.transactionsService.getTransactionsByCategory(req.user.id, period);
  }
  ...
  async update(@Request() req, @Param('id') id: string, @Body() updateTransactionDto: UpdateTransactionDto) {
    return await this.transactionsService.update(req.user.id, id, updateTransactionDto);
  }
