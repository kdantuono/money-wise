...
export class FixInitialSchema1759002732450 implements MigrationInterface {
    name = 'FixInitialSchema1759002732450'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" text, "type" "public"."categories_type_enum" NOT NULL, "status" "public"."categories_status_enum" NOT NULL DEFAULT 'active', "color" character varying(7), "icon" character varying(100), "isDefault" boolean NOT NULL DEFAULT false, "isSystem" boolean NOT NULL DEFAULT false, "sortOrder" integer NOT NULL DEFAULT '0', "rules" jsonb, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "parentId" uuid, "nsleft" integer NOT NULL DEFAULT '1', "nsright" integer NOT NULL DEFAULT '2', CONSTRAINT "UQ_420d9f679d41281f282f5bc7d09" UNIQUE ("slug"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accountId" uuid NOT NULL, "categoryId" uuid, "amount" numeric(15,2) NOT NULL, "type" "public"."transactions_type_enum" NOT NULL, "status" "public"."transactions_status_enum" NOT NULL DEFAULT 'posted', "source" "public"."transactions_source_enum" NOT NULL, "date" date NOT NULL, "authorizedDate" TIMESTAMP, "description" character varying(500) NOT NULL, "merchantName" character varying(255), "originalDescription" character varying(255), "currency" character varying(3) NOT NULL DEFAULT 'USD', "reference" character varying(255), "checkNumber" character varying(255), "isPending" boolean NOT NULL DEFAULT false, "isRecurring" boolean NOT NULL DEFAULT false, "isHidden" boolean NOT NULL DEFAULT false, "includeInBudget" boolean NOT NULL DEFAULT true, "plaid_transaction_id" character varying(255), "plaid_account_id" character varying(255), "plaidMetadata" jsonb, "location" jsonb, "notes" text, "tags" jsonb, "attachments" jsonb, "splitDetails" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "name" character varying(255) NOT NULL, "type" "public"."accounts_type_enum" NOT NULL, "status" "public"."accounts_status_enum" NOT NULL DEFAULT 'active', "source" "public"."accounts_source_enum" NOT NULL, "currentBalance" numeric(15,2) NOT NULL DEFAULT '0', "availableBalance" numeric(15,2), "creditLimit" numeric(15,2), "currency" character varying(3) NOT NULL DEFAULT 'USD', "institutionName" character varying(255), "accountNumber" character varying(255), "routingNumber" character varying(255), "plaid_account_id" character varying(255), "plaid_item_id" character varying(255), "plaid_access_token" text, "plaidMetadata" jsonb, "isActive" boolean NOT NULL DEFAULT true, "syncEnabled" boolean NOT NULL DEFAULT true, "lastSyncAt" TIMESTAMP, "syncError" character varying(500), "settings" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "firstName" character varying(255) NOT NULL, "lastName" character varying(255) NOT NULL, "passwordHash" character varying(255) NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', "status" "public"."users_status_enum" NOT NULL DEFAULT 'active', "avatar" character varying(255), "timezone" character varying(10), "currency" character varying(3) NOT NULL DEFAULT 'USD', "preferences" jsonb, "lastLoginAt" TIMESTAMP, "emailVerifiedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
