...
describe('SecurityHeader Component', () => {
  describe('Static Content', () => {
    it('should render security header with title and description', () => {
      ...
      expect(screen.getByText('Enter credentials to unlock MoneyWise')).toBeInTheDocument()
    })
  ...
  describe('Unlocking State', () => {
    it('should show authenticating message when unlocking', () => {
      ...
      expect(screen.queryByText('Enter credentials to unlock MoneyWise')).not.toBeInTheDocument()
    })
  ...
  describe('Visual Elements', () => {
    it('should render all required status indicators', () => {
      ...
      const statusContainer = screen.getByText('SYSTEM ONLINE').closest('.flex')
