...
export const SecurityHeader: React.FC<SecurityHeaderProps> = ({ isUnlocking }) => {
  return (
    <CardHeader className="text-center relative z-30">
      <motion.div
        className="mx-auto mb-4 relative"
        animate={isUnlocking ? { scale: [1, 1.1, 1], rotate: [0, 5, -5, 0] } : {}}
      ...
      <CardDescription className="text-slate-300">
        {isUnlocking ? 'Authenticating...' : 'Enter credentials to unlock MoneyWise'}
      </CardDescription>
