        ...
        <div className="space-y-3">
          ...
          {onShowDialog && (
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 border border-border text-sm font-medium rounded-md text-foreground bg-white hover:bg-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
