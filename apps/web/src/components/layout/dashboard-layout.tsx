...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen bg-muted">
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-border transform transition-transform duration-300 ease-in-out
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden lg:flex flex-1 max-w-lg">
              <div className="relative w-full">
                ...
                <input
                  type="text"
                  className="block w-full pl-10 pr-3 py-2 border border-border rounded-lg leading-5 bg-white placeholder-muted-foreground focus:outline-none focus:placeholder-muted-foreground focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
