...
export const componentLibrary: Record<string, ComponentInfo> = {
  ...
  BalanceHistory: {
    name: 'BalanceHistory',
    description: 'Interactive area chart displaying balance trends over time with accessibility features and responsive design.',
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        description: 'Array of balance data points. Uses mock data if not provided.',
        examples: ['[{ month: "Jan", balance: 1000, income: 500, expenses: 300 }]']
      },
      {
        name: 'timeRange',
        type: '"all" | "6m" | "3m"',
    ...
    animations: true,
    testCoverage: 95,
    performanceNotes: 'Optimized with useMemo for data calculations and motion.div for smooth animations',
    browserSupport: ['Chrome 90+', 'Firefox 88+', 'Safari 14+', 'Edge 90+']
  },

  WeeklyActivity: {
    name: 'WeeklyActivity',
    description: 'Interactive bar chart showing weekly financial activity with multiple view modes and enhanced tooltips.',
    category: ComponentCategory.CHARTS,
    status: ComponentStatus.STABLE,
    accessibilityLevel: AccessibilityLevel.WCAG_AA,
    version: '2.0.0',
    ...
    props: [
      ...
      },
      {
        ...
        required: false,
        description: 'Array of weekly activity data. Uses mock data if not provided.'
      },
      {
    ...
    animations: true,
    testCoverage: 92,
    performanceNotes: 'Uses AnimatePresence for smooth view transitions and useMemo for calculations',
    browserSupport: ['Chrome 90+', 'Firefox 88+', 'Safari 14+', 'Edge 90+']
  },
  ...
  CreditCards: {
    name: 'CreditCards',
    description: 'Advanced credit card display component with 3D animations, security features, and comprehensive accessibility.',
    ...
    props: [
      {
        ...
        type: 'CreditCardData[]',
        required: false,
        description: 'Array of credit card data. Uses mock data if not provided.'
      },
      {
        name: 'onCardClick',
    ...
    animations: true,
    testCoverage: 88,
    performanceNotes: '3D hover effects optimized with transform3d and will-change properties',
    browserSupport: ['Chrome 90+', 'Firefox 88+', 'Safari 14+', 'Edge 90+']
  },
  ...
  DashboardWrapper: {
    ...
    description: 'Authentication wrapper component with loading states and redirect handling.',
