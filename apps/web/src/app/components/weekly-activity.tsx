        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-neutral-600 dark:text-neutral-400">Deposits</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-neutral-600 dark:text-neutral-400">Withdrawals</span>
              </div>
          ...
          <div className="border-t border-neutral-200 dark:border-neutral-600 pt-2">
            <div className="flex items-center justify-between">
              <span className="text-xs text-neutral-600 dark:text-neutral-400">Net Flow:</span>
            ...
            <div className="flex items-center justify-between mt-1">
              <span className="text-xs text-neutral-600 dark:text-neutral-400">Transactions:</span>
...
export function WeeklyActivity() {
  ...
  const weeklyTotals = useMemo(() => {
    ...
    const totalWithdrawals = weeklyData.reduce((sum, day) => sum + day.withdraw, 0);
  ...
  const getBarColor = (value: number, type: 'deposit' | 'withdraw' | 'net') => {
    ...
    if (type === 'net') return value >= 0 ? 'hsl(var(--success-500))' : 'hsl(var(--error-500))';
    ...
    <Card className="p-6 rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-card hover:shadow-card-hover transition-shadow duration-300">
      ...
      <div className="flex flex-col space-y-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
          ...
          <div className="flex flex-col sm:items-end text-right">
            <div className={`text-lg font-bold flex items-center ${
              ...
              {weeklyTotals.netFlow >= 0 ? '+' : ''}${weeklyTotals.netFlow.toLocaleString()}
            </div>
        ...
        <div className="flex items-center space-x-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg p-1">
          {[
            { key: 'comparison' as ViewMode, label: 'Comparison', icon: BarChart3 },
            { key: 'net' as ViewMode, label: 'Net Flow', icon: TrendingUp },
            { key: 'volume' as ViewMode, label: 'Volume', icon: ArrowUpFromLine }
          ].map((option) => (
            <Button
              key={option.key}
      ...
      {/* Chart Container */}
      <div className="h-[280px] w-full" role="img" aria-label="Weekly activity chart">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              {viewMode === 'net' && (
                <Bar dataKey="net" radius={[4, 4, 4, 4]} barSize={30} name="Net Flow">
      ...
      >
        ...
        <div className="flex items-center space-x-4 text-financial-caption">
          <div>
            <span className="text-success-600">↑ ${weeklyTotals.totalDeposits.toLocaleString()}</span>
          </div>
          <div>
            <span className="text-error-600">↓ ${weeklyTotals.totalWithdrawals.toLocaleString()}</span>
          </div>
          <div>
