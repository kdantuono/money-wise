  ...
  return (
    <Card className='rounded-3xl'>
      {transactions.map(transaction => (
        <div key={transaction.name} className='flex items-center gap-4 p-4'>
          <div
            className='h-10 w-10 rounded-full flex items-center justify-center text-base'
          ...
          <div
            className={
              transaction.amount > 0
                ? 'text-[#59d9b3] text-sm font-medium'
